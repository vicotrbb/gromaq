...
- Terminal-generated Primary/Secondary DA, DECID, regular and DEC private DSR cursor-position/status replies, and xterm window-state/window-position/text-area size/title reports with native PTY write-back
