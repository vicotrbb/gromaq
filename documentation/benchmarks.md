...
average interval 13772016 ns, max interval 74883542 ns, p95 bucket 16000000 ns,
66 dropped frames, and `frame pacing accepted: false`. This is live-window
evidence, but it is still not a 144Hz acceptance pass.
