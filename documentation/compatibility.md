...
| README welcome preview image | `cargo run -- --welcome-preview-snapshot target/gromaq-readme-welcome-preview.ppm` on 2026-06-25 produced a 1468x820 prepared-frame PPM with 28548 high-contrast text pixels, 498 glyph quads, 0 cursor quads, and 387200 atlas bytes; `sips -s format png` converted it to `images/screenshots/gromaq-welcome-preview.png` for the README | Proven as committed prepared-frame visual asset |
