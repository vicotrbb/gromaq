...
tool counts, as the `gromaq-current-host-compatibility-proof` artifact. CI also
has a Linux compatibility job that installs common Ubuntu shell/editor/TUI tools, runs the
