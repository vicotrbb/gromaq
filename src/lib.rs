...
pub use config::{
    ...
    DEFAULT_SELECTION_RGB8, DEFAULT_SURFACE_PADDING_PX, FontSettings, GromaqConfig,
    MAX_LINE_HEIGHT_PX, MIN_LINE_HEIGHT_PX, PerformanceSettings, ShellSettings, TerminalSettings,
    ThemeSettings,
};
