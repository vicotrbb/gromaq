...
pub use config::{
    ...
    DEFAULT_ANSI_COLORS_RGB8, DEFAULT_BACKGROUND, DEFAULT_BACKGROUND_OPACITY,
    DEFAULT_BACKGROUND_RGB8, DEFAULT_CURSOR, DEFAULT_CURSOR_RGB8, DEFAULT_DIM_OPACITY,
    DEFAULT_FONT_FAMILY, DEFAULT_FOREGROUND, DEFAULT_FOREGROUND_RGB8, DEFAULT_SELECTION,
    ...
    TerminalSettings, ThemePresetSetting, ThemeSettings, TmuxSettings, TmuxWorkspaceSettings,
    TmuxWorkspaceWindowSettings, WelcomeSettings, format_theme_preset, parse_theme_preset,
};
