...
pub use config::{
    ...
    DEFAULT_THEME_PRESET, FontSettings, GHOSTTY_THEME_PRESET, GRAPHITE_THEME_PRESET, GromaqConfig,
    MAX_CELL_WIDTH_PX, MAX_DIM_OPACITY, MAX_LINE_HEIGHT_PX, MIN_CELL_WIDTH_PX, MIN_DIM_OPACITY,
    MIN_LINE_HEIGHT_PX, PerformanceSettings, ShellSettings, TerminalSettings, ThemePresetSetting,
    ThemeSettings, format_theme_preset,
};
