...
pub trait TerminalTestApi {
    ...
    /// Drain response bytes generated by terminal status/report queries.
    fn take_pending_response_bytes(&mut self) -> Vec<u8>;
...
impl TerminalTestApi for Terminal {
    ...
    fn take_pending_response_bytes(&mut self) -> Vec<u8> {
        Terminal::take_pending_response_bytes(self)
    }
