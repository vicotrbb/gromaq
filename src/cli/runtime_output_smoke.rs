...
pub(super) use memory::runtime_memory_smoke_exit;
...
const RUNTIME_MEMORY_SMOKE_MEASURED_BATCHES: usize = 8;
const RUNTIME_MEMORY_SMOKE_RSS_GROWTH_LIMIT_KIB: u64 = 64 * 1024;
