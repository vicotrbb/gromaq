...
pub(in crate::cli) fn usage() -> String {
    concat!(
        ...
        "--window-glyph-frame-snapshot <path>|--window-tmux-manager-snapshot <path>|",
        "--osc52-clipboard-smoke|",
        ...
        "--runtime-repaint-smoke|--runtime-tool-workflow-smoke|--runtime-tmux-smoke|",
        "--runtime-tmux-ui-smoke|--tmux-assist|--tmux-manager|--tmux-action <id> [target] [name] [--confirm]|",
