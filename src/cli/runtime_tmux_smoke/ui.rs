...
use render::{
    render_manager_panel, render_manager_panel_contains, render_no_server_start_hint,
    render_outside_attach_hint, render_startup_manager_after_shell_prompt, render_status_strip,
};
use shortcuts::{
