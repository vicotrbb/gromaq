const DEFAULT_FONT_SIZE_MIN_PX: u16 = 32;
const DEFAULT_CELL_WIDTH_MIN_PX: u16 = 18;
const DEFAULT_LINE_HEIGHT_MIN_PX: u16 = 44;
...
mod tests {
    ...
    fn default_font_metrics_gate_accepts_current_readable_defaults() {
        assert!(has_readable_default_font_metrics(32, 18, 44));
    }
    ...
    fn default_font_metrics_gate_rejects_cramped_or_loose_geometry() {
        assert!(!has_readable_default_font_metrics(32, 16, 44));
        assert!(!has_readable_default_font_metrics(32, 18, 54));
    }
}
