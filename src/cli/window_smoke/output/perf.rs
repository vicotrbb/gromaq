...
pub(in crate::cli::window_smoke) fn window_perf_no_glyph_failure(
...
pub(in crate::cli::window_smoke) fn window_perf_success(
    report: &NativeAppRunReport,
    frame_limit: u64,
    target_fps: u32,
    elapsed: Duration,
