...
pub use theme::{
    ...
    DEFAULT_SELECTION_RGB8, DEFAULT_SURFACE_PADDING_PX, DEFAULT_THEME_PRESET, GHOSTTY_THEME_PRESET,
    GRAPHITE_THEME_PRESET, MAX_DIM_OPACITY, MIN_DIM_OPACITY, ThemePresetSetting, ThemeSettings,
    format_theme_preset,
};
