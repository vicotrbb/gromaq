...
pub use theme::{
    ...
    DEFAULT_BACKGROUND, DEFAULT_BACKGROUND_RGB8, DEFAULT_CELL_SPACING_PX, DEFAULT_CURSOR,
    DEFAULT_CURSOR_RGB8, DEFAULT_DIM_OPACITY, DEFAULT_FOREGROUND, DEFAULT_FOREGROUND_RGB8,
    DEFAULT_SELECTION, DEFAULT_SELECTION_RGB8, DEFAULT_SURFACE_PADDING_PX, DEFAULT_THEME_PRESET,
    GHOSTTY_THEME_PRESET, GRAPHITE_THEME_PRESET, MAX_CELL_SPACING_PX, MAX_DIM_OPACITY,
