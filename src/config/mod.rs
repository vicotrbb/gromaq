...
pub use theme::{
    ANSI_COLOR_COUNT, DEFAULT_ANSI_COLORS, DEFAULT_ANSI_COLORS_RGB8, DEFAULT_BACKGROUND,
    DEFAULT_BACKGROUND_RGB8, DEFAULT_CURSOR, DEFAULT_CURSOR_RGB8, DEFAULT_FOREGROUND,
    DEFAULT_FOREGROUND_RGB8, DEFAULT_SURFACE_PADDING_PX, ThemeSettings,
};
