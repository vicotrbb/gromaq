...
Native runtime render counters include sample count, total, max, and a bounded bucketed p95 estimate for rendered dirty frames. Those counters are structured inputs for future live-window proof, but they do not by themselves prove hardware-backed p95 frame time.
