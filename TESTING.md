...
also runs the theme, avatar asset freshness, welcome, README screenshot
freshness, current-host compatibility, and benchmark inventory proof helpers.
Use the expanded command list when you need to rerun or debug an individual
gate.
