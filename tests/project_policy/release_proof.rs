...
fn macos_native_tmux_manual_proof_guides_live_manager_workflow() {
    ...
    for marker in [
        ...
        "GROMAQ_MANUAL_TMUX_PREFLIGHT_ONLY",
        ...
        "tmux-binary-markers.txt",
        "tmux-window-smoke.stdout",
        "selected executable window smoke did not present three settled frames",
        ...
        "selected executable manager reference did not report terminal cells",
        "tmux manager sessions:",
        "target/debug/gromaq",
        "open -W -n",
        "live-window-started-at.txt",
        "live-window-finished-at.txt",
        "date -u +%Y-%m-%dT%H:%M:%SZ",
        "gromaq-native-tmux-manual.toml",
        "manual-tmux-shell.sh",
        "tmux-session.txt",
        "tmux-initial-windows.txt",
        "tmux-initial-panes.txt",
        ...
        "workspace-launched",
        "tmux-workspace-session-exists.txt",
...
fn macos_native_tmux_default_cargo_run_proof_guides_no_arg_workflow() {
    ...
    for marker in [
        ...
        "git -C \"${root}\" status --short --branch",
        "git-status.txt",
        "GROMAQ_DEFAULT_CARGO_TMUX_PREFLIGHT_ONLY",
        ...
        "tmux-default-cargo-run-initial-windows.txt",
        "tmux-default-cargo-run-initial-panes.txt",
        "initial tmux windows:",
        "initial tmux panes:",
        ...
        "default window smoke did not present three settled frames",
        ...
        "tmux-default-cargo-run-live-window-started-at.txt",
        "tmux-default-cargo-run-live-window-finished-at.txt",
        "date -u +%Y-%m-%dT%H:%M:%SZ",
        "unexpected old startup marker",
        ...
        "Confirm Cmd/Ctrl+Shift+T opened or reopened a real manager panel.",
