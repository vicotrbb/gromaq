...
fn distribution_assets_keep_desktop_identity() {
    ...
    assert!(screenshot_script.contains("System Settings > Privacy & Security"));
    assert!(screenshot_script.contains("Screen & System Audio Recording"));
    ...
    assert!(screenshot_script.contains("summary.txt"));
    assert!(screenshot_script.contains("default startup content checked: true"));
    assert!(screenshot_script.contains("tmux status strip rendered: true"));
    assert!(screenshot_script.contains("tmux manager panel rendered: true"));
    ...
    assert!(macos_identity_script.contains("surface occluded"));
    ...
    assert!(arch_proof_script.contains("Payload entries:"));
    assert!(arch_proof_script.contains("/proof/payload-count.txt"));
