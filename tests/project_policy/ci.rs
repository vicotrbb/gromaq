...
const REQUIRED_CI_COMMANDS: &[&str] = &[
    ...
    "sh -n scripts/prove-macos-live-input-manual.sh",
    "sh -n scripts/prove-macos-native-tmux-manual.sh",
    ...
    "sh -n scripts/prove-github-release-macos-install.sh",
...
const REQUIRED_RELEASE_WORKFLOW_COMMANDS: &[&str] = &[
    ...
    "GROMAQ_MACOS_UNIVERSAL=1 scripts/package-macos-app.sh",
    "file target/dist/Gromaq.app/Contents/MacOS/gromaq",
    "lipo -info target/dist/Gromaq.app/Contents/MacOS/gromaq",
    "codesign --verify --deep --strict --verbose=4 target/dist/Gromaq.app",
    "codesign -dv --verbose=4 target/dist/Gromaq.app",
